...
/world/proc/update_status()
	...
	s += "<b>[station_name()]</b>";
	s += " ("
	s += "<a href=\"https://keplerstation.cf\">" //Change this to wherever you want the hub to link to. CIT CHANGE - links to cit's website on the hub
	s += "Kepler"  //Replace this with something else. Or ever better, delete it and uncomment the game version. CIT CHANGE - modifies the hub entry link
	s += "</a>"
