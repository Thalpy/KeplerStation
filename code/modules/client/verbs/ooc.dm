	...
	for(var/client/C in GLOB.clients)
		if(C.prefs.chat_toggles & CHAT_OOC)
			if(holder)
				...
				if(src in GLOB.mentors)
					to_chat(C, "<font color='[KEPLER_MENTOR_OOC_COLOUR]'><b><span class='prefix'>OOC:</span> <EM>[keyname]:</EM> <span class='message linkify'>[msg]</span></b></font>")
